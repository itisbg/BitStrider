...
assert ENTRY_WINDOW_START_ET == "09:30"
...
# Inside the window.
assert _within_entry_window(_at(9, 30)) is True, "exactly at open boundary -> inside (inclusive)"
...
# Outside the window.
assert _within_entry_window(_at(9, 29)) is False, "one minute before open -> outside"
...
print("OK: entry window is inclusive of both boundaries (09:30-15:50 ET), rejects everything outside it, and never extends past EOD_CLOSE_TIME")
