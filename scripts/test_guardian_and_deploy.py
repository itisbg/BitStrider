...
def test_watchdog_deploy_window_and_flag() -> None:
    ...
    check("deploy window 15:50 ET blocked", w._deploy_window_allows(at(15, 50)) is False)
    check("deploy window 15:51 ET allowed (after EOD)", w._deploy_window_allows(at(15, 51)) is True)
